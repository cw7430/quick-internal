...
class GetMessageListTest : ChatControllerTest() {
    @Test
    @DisplayName("채팅 메세지 목록 불러오기 - 성공")
    fun success() {
    ...
    @Test
    @DisplayName("채팅 메세지 목록 불러오기 - 인증 오류")
    ...
    @Test
    @DisplayName("채팅 메세지 목록 불러오기 - 잘못 된 토큰")
    ...
    @Test
    @DisplayName("채팅 메세지 목록 불러오기 - 만료 된 토큰")
